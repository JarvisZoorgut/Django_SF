...
from .views import PostList, PostDetail, NewsCreate, ArticlesCreate, NewsEdit, ArticlesEdit, NewsDelete, ArticlesDelete

urlpatterns = [
    path('posts/', PostList.as_view(template_name = 'newsportal/posts.html'), name='posts'),
